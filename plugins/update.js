    ...
    if (cmd === "update") {
        ...
        try {
            ...
            const newsletterConfig = {
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        newsletterName: '𝐓𝐄𝐂𝐇-𝐃𝐄𝐕𝐒-𝐈𝐈𝐍𝐂 𝐔𝐏𝐃𝐀𝐓𝐄𝐒',
                        serverMessageId: 143
                    }
                }
            };
            ...
            const msg = await Matrix.sendMessage(m.from, { 
                text: "```🔍 Checking for TKT-CYBER_AI updates...```",
                ...newsletterConfig
            }, { quoted: m });
            ...
            const { data: commitData } = await axios.get(
                "https://api.github.com/repos/tkttech/TKT-CYBER-AI/commits/main",
                {
                    headers: {
                        'User-Agent': 'TKT-CYBER-AI-Bot'
                    }
                }
            );
            ...
            if (latestCommitHash === currentHash) {
                if (m.React) await m.React("✅");
                await sendUpdateMessage("✅ *Your TKT-CYBER-AI bot is already up-to-date!*");
                return;
            }

            await sendUpdateMessage("🚀 *New update found! Downloading TKT-CYBER-AI...*\n\n_This may take a few moments..._");
            ...
            const response = await axios({
                method: 'get',
                url: "https://github.com/tkttech/TKT-CYBER-AI/archive/main.zip",
                responseType: 'stream',
                headers: {
                    'User-Agent': 'TKT-CYBER-AI-Bot'
                }
            ...
            const sourcePath = path.join(extractPath, "TKT-CYBER-AI-main");
            ...
            try {
                await Matrix.sendMessage(m.from, {
                    image: { 
                        url: "https://files.catbox.moe/d622xc.png",
                        mimetype: "image/jpeg"
                    },
