...
`;
    ...
    const defaultImageUrl = "https://files.catbox.moe/1cp4yq.jpeg";
    ...
    const buttons = [
      ...
      },
      {
        ...
        buttonParamsJson: JSON.stringify({
          ...
          url: `https://whatsapp.com/channel/0029Vb5vbMM0LKZJi9k4ED1a`
        }),
      },
    ];
