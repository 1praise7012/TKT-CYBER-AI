...
const menuImages = [
  "https://files.catbox.moe/h48dlj.jpg",
  "https://files.catbox.moe/d622xc.png",
  "https://files.catbox.moe/1cp4yq.jpeg" // Add your third image URL here
];
  ...
  try {
    ...
    await Matrix.sendMessage(m.from, {
      ...
      quoted: {
        ...
        message: {
          contactMessage: {
            displayName: "ᴛᴋᴛ-ᴄʏʙᴇʀ ᴀɪ ✅",
            vcard: `BEGIN:VCARD\nVERSION:3.0\nFN: ᴛᴋᴛ-ᴛᴇᴄʜ VERIFIED ✅\nORG:TKT-CYBER-AI BOT;\nTEL;type=CELL;type=VOICE;waid=13135550002:+13135550002\nEND:VCARD`
          }
        }
      }
    });
      ...
      if (menuImage) {
        await Matrix.sendMessage(m.from, { 
          ...
          quoted: {
            ...
            message: {
                contactMessage: {
                    displayName: "TAFADZWA VERIFIED ✅",
                    vcard: "BEGIN:VCARD\nVERSION:3.0\nFN: TKT-CYBER-AI VERIFIED ✅\nORG:TKT-CYBER-AI BOT;\nTEL;type=CELL;type=VOICE;waid=13135550002:+13135550002\nEND:VCARD"
                }
            }
          }
        });
        ...
        await Matrix.sendMessage(m.from, {
          ...
          quoted: {
            ...
            message: {
              contactMessage: {
                displayName: "TKT-CYBER_TECH✅",
                vcard: `BEGIN:VCARD\nVERSION:3.0\nFN: TKT-CYBER_TECH VERIFIED ✅\nORG:TKT-CYBER-AI-TECH BOT;\nTEL;type=CELL;type=VOICE;waid=13135550002:+13135550002\nEND:VCARD`
              }
            }
          }
        });
...
`;
    ...
    await Matrix.sendMessage(m.from, {
      text: `•
• *📁 ᴛᴋᴛ-ᴄʏʙᴇʀ ᴀɪ* hit a snag! Error: ${error.message || "Failed to load menu"} 😡
•`,
    }, { quoted: m });
  }
};
